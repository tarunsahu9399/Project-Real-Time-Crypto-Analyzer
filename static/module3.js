...
addRowButton.addEventListener("click", function() {
  ...
  const coinYouHaveCell = document.createElement("td");
  coinYouHaveCell.innerHTML = '<input class="Coins_you_have" type="text">';
  ...
  moneyYouWantToInvestCell.innerHTML = '<p class="Money_You_Want_To_Invest " ></p>';
  ...
  newRow.appendChild(coinYouHaveCell);
